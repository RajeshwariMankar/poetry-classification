...
#emotions list
emotions=[('love','love'),('joy','joy'),('peace','peace'),('sad','sad'),('fear','fear'),('hate','hate')]
...
def create_poem_entry():
    ...
    for (sentiment, emotion) in emotion_of_poems:
        ...
        complete_url=url+searchdir+sentiment
        ...
        while True:
            ...
            for p in  elements.find_all('li'):
                print("P",p)
                #for accessing title of the poem
                title_of_poem = p.a.get_text().strip().encode('utf-8')
                ...
                poemfile_name.write(title_of_poem.upper().decode("utf-8") + str('\n\n'))
